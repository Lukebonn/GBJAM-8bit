...
static var GUESTS_DATA: Dictionary[String, Dictionary] = {
	"The Evil 1": {
		DESCRIPTION: "To Whom It May Concern, Greetings! You may have heard of me as the one they call 
		The Evil. I’ve been working hard to conquer all the seven lands but my army has hit a wall and 
		I need help to get them past it. Can you bring me an absolute healing potion? You will be 
	...
	"The Evil 2": {
		...
		insane to want to help me but either way, you have been very helpful. Next, can you get me a 
	...
	"The Evil 4": {
		...
		I presume with that entrepreneurial spirit, however, that you’d prefer to be alone. 
