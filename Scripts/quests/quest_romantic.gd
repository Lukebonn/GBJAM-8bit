...
static var QUESTS_DATA: Dictionary[String, Dictionary] = {
	"The Romantic 1": {
		DESCRIPTION: "Dear Alchemist, pleased to meet you! I am inquiring about your services on the 
	...
	"The Romantic 2": {
		...
		showcase my qualities as a partner. How else will they love me if I don’t show them why they 
	...
	"The Romantic 5": {
		...
		they told me to never see them again. I understand, after all I did trick them. I want my next 
